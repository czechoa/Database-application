...
from app.models.skill import SkillPublic,SkillCreate, SkillConnection
...
@router.post("/skills_connect/", response_model= SkillConnection, name="skill:f create_skill_and_connect_skill_to_course")
